    ...
    case 'Absolute'
        ...
        for k=1:numGraphs
            ...
            for l=1:numGroups
                ...
                CurrMedian = median(ObjectCount{l});
                plot(TestedThresholds,CurrMedian,'Color','k','Linewidth',3);
                hold on;
            end
    ...
    case 'Relative'
        if bnThresholdIsOk == false
            ...
            for k=1:numGraphs
                ...
                CurrMedian = median(RelativeCount,1);
                plot(TestedThresholds,CurrMedian,'Color','k','Linewidth',3);
                hold on;
                ...
                line([numChosenThreshold,numChosenThreshold],[0 maxValue],'Color','g','Linewidth',3);
