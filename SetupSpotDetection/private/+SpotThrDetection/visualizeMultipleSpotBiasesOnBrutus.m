function visualizeMultipleSpotBiasesOnBrutus(cellBatchPath,cellObjName,cellDescription,ImageDimensions)
...
smBias=zeros([ImageDimensions numSpotfiles]);
...
for k= 1:numSpotfiles
    ...
    smBias(:,:,k) = filtImage./mean(filtImage(:));
