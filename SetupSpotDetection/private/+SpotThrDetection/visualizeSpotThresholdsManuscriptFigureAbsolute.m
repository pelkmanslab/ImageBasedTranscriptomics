function visualizeSpotThresholdsManuscriptFigureAbsolute(ObjectCount, TestedThresholds, strMethod, numChosenThreshold,ZoomOnY,customxLimits)
    ...
    case 'Absolute'
        ...
        for k=1:numGraphs
            ...
            if bnThresholdIsOk == true
                line([numChosenThreshold,numChosenThreshold],[0 maxValue],'Color','b','Linewidth',3); % indicate recommeneded threshold
            end
